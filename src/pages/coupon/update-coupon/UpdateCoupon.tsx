      ...
      <Form {...layout}>
        <Form.Item label="优惠券名称">
          <Input
            ...
            onChange={(e) =>
              setCouponInfo({ ...couponInfo, couponName: e.target.value })
            }
          />
        </Form.Item>
        ...
        {couponType === 'fullCoupon' ? (
            ...
            <Form.Item label="满减券">
              ...
              <Form.Item noStyle>
                <InputNumber
                  ...
                  onChange={(e: number | string | any) =>
                    setCouponInfo({ ...couponInfo, fullCoupon: e })
                  }
                />
              </Form.Item>
            </Form.Item>
            <Form.Item label="满减券">
              ...
              <Form.Item noStyle>
                <InputNumber
                  ...
                  onChange={(e) => {
                    setCouponInfo({ ...couponInfo, subCoupon: e });
                  }}
                />
              </Form.Item>
            </Form.Item>
          ...
          >
            <InputNumber
              ...
              onChange={(e) => {
                setCouponInfo({ ...couponInfo, discountCoupon: e });
              }}
            />
          </Form.Item>
        )}
        ...
        <>
          <Form.Item label="优惠券的描述">
            <Input.TextArea
              placeholder="请输入对优惠券的描述"
              value={couponInfo.introduction}
              onChange={(e) => {
                setCouponInfo({ ...couponInfo, introduction: e.target.value });
              }}
            />
          </Form.Item>
        </>
