    ...
    <Card title={<span> {updateStr}房型</span>}>
      <Form.Item label="房间类型" {...layout}>
        <Input
          ...
          onChange={(e: any) => {
            setRoomTypeData({ ...roomTypeData, roomType: e.target.value });
          }}
        />
      </Form.Item>
      ...
      <Form.Item {...layout} label="房型介绍">
        <Input.TextArea
          value={roomTypeData.introduction}
          onChange={(e: any) =>
            setRoomTypeData({ ...roomTypeData, introduction: e.target.value })
          }
        />
      </Form.Item>
      ...
      <Form {...layout}>
        ...
        <Form.Item label="房间号" rules={[{ required: true }]}>
          <Input
            ...
            onChange={(e: any) => {
              setRoomData({ ...roomData, roomNum: e.target.value });
            }}
          />
        </Form.Item>
        <Form.Item label="电脑配置">
          <Input.TextArea
            value={roomData.computer}
            onChange={(e: any) => {
              setRoomData({ ...roomData, computer: e.target.value });
            }}
          />
        </Form.Item>
        <Form.Item label="房间简介">
          <Input.TextArea
            value={roomData.introduction}
            onChange={(e: any) => {
              setRoomData({ ...roomData, introduction: e.target.value });
            }}
          />
        </Form.Item>
